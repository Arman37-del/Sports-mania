...
import { Nav, Col, Container, Row, Spinner } from 'react-bootstrap';
...
const TeamDetails = () => {
    ...
    const first100Paragraphs = description?.slice(0, 150).join(" ")
    const second100Paragraphs = description?.slice(100, 250).join(" ")
                ...
                <div className="team-details-container">
                    ...
                    <div className="nav-container">
                        <Nav className=" justify-content-center" defaultActiveKey="/home" as="ul">
                            <Link to="/">Home</Link> {'>'}
                            <Link className="active" to={"/team/" + idTeam}> Team </Link>
                        </Nav>
                    </div>
